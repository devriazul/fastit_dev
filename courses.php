                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="services-item">
                            <div class="services-image">
                                <a href="courses_details.php?sid=<?php echo $rows['sid']; ?>"><img src="assets/images/courses/<?php echo $rows['image']; ?>" alt="image"></a>
                            </div>
                            <div class="services-content">
                                <h3>
                                    <a href="courses_details.php?sid=<?php echo $rows['sid']; ?>"><?php echo $rows['c_name']; ?></a>
                                </h3>
                                <p><?php echo $rows['c_price']; ?></p>
                            </div>
                        </div>
                    </div>
