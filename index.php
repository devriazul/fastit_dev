<?php include "inc/header.php";?>
        ...
        <div class="main-slides-area">
            ...
            <?php
$Select = "SELECT * FROM slide ORDER BY sid ASC";
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-7 col-md-12">
                                <div class="main-slides-content">
                                    <span data-aos="fade-right" data-aos-delay="70" data-aos-duration="700" data-aos-once="true"><?php echo $rows['title']; ?></span>
                                    <h1 data-aos="fade-right" data-aos-delay="70" data-aos-duration="700" data-aos-once="true">We provide Software Design & Development.<span class="overlay"></span></h1>
                                    <p data-aos="fade-right" data-aos-delay="70" data-aos-duration="700" data-aos-once="true"><?php echo $rows['description']; ?></p>

                                    <div class="slides-btn" data-aos="fade-right" data-aos-delay="70" data-aos-duration="700" data-aos-once="true">
                                        <a href="#" class="default-btn text-white">Get Started</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12">
                        <div class="about-image" data-tilt>
                            <img src="assets/images/about/about.jpg" alt="image" data-aos="fade-down" data-aos-delay="80" data-aos-duration="800" data-aos-once="true">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12">
                        <div class="about-content" data-aos="fade-up" data-aos-delay="80" data-aos-duration="800" data-aos-once="true">
                            ...
                            <p>Fast IT is the best software development/consulting company in Bangladesh committed to providing the all sorts of industry with quality and evolving software and services that are intended to manage and improve all aspects of the business process. We offer a complete solution that includes software, hardware, consultation, training, and support through implementation and beyond.</p>
                            <div class="about-btn">
        ...
        <div class="services-area with-radius ptb-100">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-lg-4 col-md-12">
                        <div class="services-section-content" data-aos="fade-down" data-aos-delay="80" data-aos-duration="800" data-aos-once="true">
                            ...
                            <div class="services-section-btn">
                                <a href="#" class="default-btn">Explore All Services</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php
$Select = "SELECT * FROM service ORDER BY sid ASC";
$query = mysqli_query($conn, $Select);
$i = 1;
foreach ($query as $rows) {?>
                            <div class="services-item">
                                <div class="services-image">
                                    <a href="services-details.php?sid=<?php echo $rows['sid']; ?>">
                                        <img src="admingigaenterprise/uploads/<?php echo $rows['image']; ?>" alt="image">
                                    </a>
                                </div>
                               <div class="services-content">
                                <h3>
                                    <a href="services-details.php?sid=<?php echo $rows['sid']; ?>"><?php echo $rows['title']; ?></a>
                                </h3>
        ...
        <div class="projects-area with-black-background pb-100">
            <div class="container-fluid">
                ...
                <div class="projects-slides owl-carousel owl-theme">
                    <?php
                    $Select = "SELECT * FROM client_project ORDER BY sid ASC";
                    $query = mysqli_query($conn, $Select);
                    $i = 1;
                    foreach ($query as $rows) {?>
                    <div class="projects-item" data-aos="fade-up" data-aos-delay="50" data-aos-duration="500" data-aos-once="true">
                        <div class="projects-image">
                            <a href="<?php echo $rows['d_url']; ?>"><img src="admingigaenterprise/uploads/<?php echo $rows['d_image']; ?>" alt="image"></a>
                        </div>
                        <div class="projects-content">
                            <h3>
                                <a href="<?php echo $rows['d_url']; ?>"> <?php echo $rows['name']; ?></a>
                            </h3>
                            <a href="<?php echo $rows['d_url']; ?>" class="projects-btn">View Project</a>
                        </div>
                    </div>
