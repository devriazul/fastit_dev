<?php 
    ...
    if (isset($_GET['sid'])) {
        $course = mysqli_query($conn, "SELECT * FROM course WHERE sid='{$_GET['sid']}'");
        ...
        <div class="page-banner-area bg-3 jarallax" data-jarallax='{"speed": 0.3}'>
            <div class="container">
                <div class="page-banner-content" data-aos="fade-right" data-aos-delay="50" data-aos-duration="500" data-aos-once="true">
                    <h2><?php echo $course_inf['c_name']; ?> </h2>
            ...
            <div class="container">
                <div class="services-details-desc">
                    <div class="article-services-image">
                        <img src="assets/images/courses/<?php echo $course_inf['image']; ?>" alt="image">
                    </div>
                    <div class="article-services-content">
                        <h3><?php echo $course_inf['c_name']; ?></h3>
                        <p><?php echo $course_inf['description']; ?></p>
                        
                        <p><?php echo $course_inf['c_price']; ?></p>
