                    ...
                    <div class="navbar-container">
                        ...
                        <ul class="nav-right">
                            ...
                            <li class="user-profile header-notification">
                                <div class="dropdown-primary dropdown">
                                    <div class="dropdown-toggle" data-toggle="dropdown">
                                        <img src="files/assets/images/pp.png" class="img-radius"
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu">
                                    <a href="javascript:void(0)">
                                        ...
                                        <span class="pcoded-mtext">Courses Menage</span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="">
                                            <a href="new_student.php">
                                                <span class="pcoded-mtext">New Student</span>
                                            </a>
                                        </li>
                                        ...
                                        <li class="">
                                            <a href="trainer.php">
                                                <span class="pcoded-mtext">All Trainer</span>
                                            </a>
                                        </li>
                                ...
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="">
                                            <a href="client.php">
                                                <span class="pcoded-mtext">Client's Projects</span>
                                            </a>
                                        </li>
