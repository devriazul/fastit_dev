                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="input-group input-group-button">
                                                    <input type="text" class="form-control"
                                                        value="<?php echo $service_inf['title']; ?>" name="title">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <label>Description </label>
                                                  <div class="input-group input-group-button">
                                                       <textarea  name="description" id="editor" class="form-control"><?php echo $service_inf['description']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
										...
										<div class="row">
                                            <div class="col-sm-12">
                                                <label>Other Description </label>
                                                  <div class="input-group input-group-button">
                                                    <textarea  name="otherdescription" id="editor1" class="form-control"><?php echo $service_inf['otherdescription']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="input-group input-group-button">
                                                     <input type="file" name="image" accept="image/*" onchange="loadFile(event)" style="opacity: 0;position: absolute; width:150px; height:180px;">
                                                        <img id="output" class="border w-25 h-25" src="uploads/<?php echo $service_inf['image']; ?>">
                                                </div>
                                            </div>
                                        </div>
