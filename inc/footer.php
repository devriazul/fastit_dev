                ...
                <div class="row justify-content-center">
                    <div class="col-lg-3 col-md-6">
                        <div class="single-footer-widget" data-aos="fade-up" data-aos-delay="50" data-aos-duration="500" data-aos-once="true">
                            ...
                            <ul class="widget-social">
                                <li>
                                    <a href="https://www.facebook.com/gigasoftbd" target="_blank">
                                        <i class="ri-facebook-fill"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://twitter.com/gigasoftbd" target="_blank">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-footer-widget" data-aos="fade-up" data-aos-delay="80" data-aos-duration="800" data-aos-once="true">
                            <h3><i class="ri-map-pin-line"></i> CORPORATE OFFICE </h3>

                             <p>203, 204 Road: 35, Block- Ta, Section-06, Mirpur, Dhaka-1216</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="copyright-area">
                <div class="container">
                    <div class="copyright-area-content">
                        <p>
                            Copyright @2022 Coze All Rights Reserved by
                            <a href="https://fastitbd.com" target="_blank">Fast IT</a>
                        </p>
                    </div>
                </div>
            </div>
